...
<section class="contact py-1">
	<div class="container">
			<div class="mail_grid_w3l">
				<form action="add_student_csv.php" method="post" enctype="multipart/form-data">
					<div class="row">
					        <div class="col-md-9"> 
							<input type="file"  name="file" id="file">
							</div>
							<div class="col-md-3">
							<input type="submit" value="Import" name="import" data-loading-text="Loading..."></input>
							</div>
					</div>
				</form>
			</div>
...
$student_qury = "SELECT * FROM Student ";
